...
$(document).ready(function(){
	var re = /<br *\/?>/gi;
	var text = '${param.content}'.replace(re,"\n");
...
<!-- form -->
	...
	<table>
		...
		<tr>
			...
			<td><textarea rows="7" cols="50" name="content" id="mytextarea" style="resize: none;"></textarea></td>
			<td> <span style="padding-left:5px;">${error.content}</span>  </td>
		</tr>
		<tr>
		<tr>
