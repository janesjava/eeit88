...
<!-- form -->
	...
	<table>
		...
		<tr>
			...
			<td><input type="text" name="foodType" value="${update.foodType}"></td>
		...
		<tr>
			<td height="80px" colspan="2">
				<input type="submit" name="foodtion" value="確認修改" class="btn btn-primary"></input>
				<input type="button" value="取　　消" class="btn btn-primary" onclick="window.location.href='<c:url value="/Manage/ShowAllFood.do"/> '">
