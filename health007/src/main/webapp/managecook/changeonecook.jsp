...
$(document).ready(function(){
	var re = /<br *\/?>/gi;
	var text = '${update.cooking}'.replace(re,"\n");
...
<!-- table -->
	...
	<table>
		...
		<tr>
			...
			<td><textarea id="mytextarea" rows="7" cols="50" name="cooking" style="resize: none;"></textarea></td>
<%-- 			<td><input type="text" name="cooking" value="${update.cooking}"></td> --%>
			<td>${error.cooking}</td>			
		</tr>
		<tr>
			<td height="50px">分類:</td>
			<td><input type="text" name="cookbookType" value="${update.cookbookType}"></td>
			<td>${error.cookbookType}</td>
		</tr>
		<tr>
		...
		<tr>
			<td height="80px" colspan="2">
				<input type="submit" name="cooktion" value="確認修改" class="btn btn-primary"></input>
				<input type="button" value="取　　消" class="btn btn-primary" onclick="window.location.href='<c:url value="/Manage/ShowAllCook.do"/> '">
			</td>
		</tr>
	</table>
	</form>
